...
{
public:
    static int encode(char * base64code, const char * src, int src_len); 
    static int encodeFile(std::string& strRet, std::string strPath);
    static int decode(char * buf, const char * base64code, int src_len = 0);
